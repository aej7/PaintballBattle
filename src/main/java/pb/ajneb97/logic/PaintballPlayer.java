...
public class PaintballPlayer {
	...
	public PaintballPlayer(Player jugador) {
		this.jugador = jugador;
		this.guardados = new SavedItems(jugador.getInventory().getContents().clone(),jugador.getEquipment().getArmorContents().clone(),jugador.getGameMode()
